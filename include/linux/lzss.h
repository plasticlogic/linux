...
/** Version string */
#define LZSS_VERSION "pldata-008"
...
/** Encode a file into an other
    ...
    @return -1 if error (i.e. I/O error), 0 otherwise
 */
extern int lzss_encode_buffer(struct lzss *lzss, char *in_buffer, int in_length,
...
/** Decode a file into an other
    ...
    @return -1 if error (i.e. I/O error), 0 otherwise
 */
extern int lzss_decode_buffer(struct lzss *lzss, char *in_buffer, int in_length,
			    char *out_buffer, int* out_length);
